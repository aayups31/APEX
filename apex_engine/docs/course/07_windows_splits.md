# Phase 07 — Session splits and sequence windows

## Goal

Prevent temporal leakage, fit normalization on train only and create histories/futures without crossing episode boundaries.

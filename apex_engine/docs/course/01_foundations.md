# Phase 01 — Physics, probability and sequence foundations

## Goal

Review units, kinematics, forces, drag, curvature, uncertainty, conditional probability, vectors, matrices, gradients and time-series dependence.

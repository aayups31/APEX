# Phase 03 — RNNs, RSSMs and state-space models

## Goal

Compare recurrence, stochastic latent dynamics, structured state space models, selective retention and attention.
